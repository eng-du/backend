...
class JwtTokenParserTest {
  ...
  void validAccessTokenExpiration() {
    ...
    // when
    assertThatThrownBy(() -> tokenParser.parseRoleFromAccessToken(rawAccessToken))
  ...
  void validRefreshTokenExpiration() {
    ...
    // when
    assertThatThrownBy(() -> tokenParser.parseUserIdFromToken(rawRefreshTokenToken))
        .isInstanceOf(JwtExpiredException.class);
  }
  ...
  void validTokenSignature() {
    ...
    // when
    assertThatThrownBy(() -> tokenParser.parseUserIdFromToken(invalidJwt))
