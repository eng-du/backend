  ...
  private String getInstructionPrompt() {
    return """
              ...
              1. **기사(article)**를 작성하세요.
                 ...
                 - 주제와 연결된 사례를 고를 때, 매번 다른 시대에서 예시를 뽑으세요.
                 - 각 본문(content)은 공백 제외 **약 800자** 내외로 작성합니다 (±10%%).
                 - 본문은 정보 전달 목적의 글이며, 영어로 작성합니다
                 - 본문의 해석본도 적습니다. 해석본은 한국어로 'translation' 에 작성합니다
              ...
              3. **퀴즈**를 만듭니다.
                 - 퀴즈는 기사의 본문과 관련된 문제 2개를 포함합니다.
                 - 문제 유형은 독해(내용 일치/불일치), 문법, 어휘(유의어/반의어) 등으로 다양하게 구성합니다.
                 - 퀴즈의 선택지(choices)는 반드시 4개여야합니다. 4개보다 적은 3개, 5개를 생성하면 안됩니다.
                 - 퀴즈의 문제 유형도 알려주세요
                              
              4. 전체 결과는 다음과 같은 JSON 포맷을 따릅니다:
              응답에는 불필요한 것을 제외하고 내용만 담으세요.
              ```json
                 {
          "title": "...",
          "articles": [
            ...
            },
            {
              ...
              위 입력을 바탕으로, 단계별로 사고한 뒤 최종 결과(본문1·퀴즈1·본문2·퀴즈2)를 작성하세요.
              """;
  }
}
